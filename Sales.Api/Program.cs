...
builder.Services.AddDbContext<Context>(options => options.UseInMemoryDatabase("SaleSytem"));
...
var key = Encoding.ASCII.GetBytes(builder.Configuration.GetSection("TokenKey").Value);
